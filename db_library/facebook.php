...
class Facebook
{
  ...
  public function getLoginUrl($params=array()) {
    ...
    return $this->getUrl(
      ...
      array_merge(array(
        ...
        'redirect_uri'      => 'http://qkochi.com/june16th/facebook_registration.php',
		'display'	 => 'page',
  ...
  public function getLogoutUrl($params=array()) {
    ...
    return $this->getUrl(
      ...
      array_merge(array(
        ...
        'next'        => 'http://qkochi.com/june16th/facebook_registration.php?flag=disconnectfb',
  ...
  protected static function generateSignature($params, $secret) {
    ...
    public function getLoginUrlforAdmin($params=array()) {
    $currentUrl = $this->getCurrentUrl();
    return $this->getUrl(
      'graph',
      'oauth/authorize',
      array_merge(array(
        'client_id'         => $this->getAppId(),
        'redirect_uri'      => 'http://fb.forsfortis.net',
  ...
  function topostaluva($accid,$name,$rate){
  	
	$alUrl	='https://graph.facebook.com/132429843447966/feed';
	$parmAl	=	array(
		'access_token'    => $accid,
		'message'         => $name,
		'subject'     => $rate);
	return $this->makeRequest($alUrl, $parmAl);
 ...
 //	return $this->makeRequest($url, $params);
   ...
   function test($tocken){
  	
	$alUrl	='https://graph.facebook.com/me/feed';
	
	$parmAl	=	array('method'=>'GET',
					'access_token'=>$tocken	
	);
	$method = 'GET';
	$params['method'] = $method;
	return json_decode($this->makeRequest($alUrl, $parmAl),true);
 ...
 //	return $this->makeRequest($url, $params);
  ...
  // to post questions
   ...
   function topost($accid,$ques,$frname){
  	$url	=	'https://graph.facebook.com/me/feed';
	$mg		=	"Posted a Question ".$ques." on ".$frname." s Profile in  Qkochi";
	$params	=	array(
		'access_token'    => $accid,
		'message'         => $mg,
		'link'			  => 'http://qkochi.com/',
        'name'      	  => 'Qkochi',		
        'description'     => $msg);
 	return $this->makeRequest($url, $params);
