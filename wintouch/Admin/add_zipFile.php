...
if(isset($_POST["addButton"])){	
    ...
    $uploader	=	new Uploader("../uploads/zip_file/");
	...
	if($obj->addzipFile($_POST,$path)){
		$msg1 = "Added successfully !";			
	}	
	}else{
		$msg1=	$obj->errorMessage;
	}
	header("Location:add_zipFile.php?msg1=$msg1");
	exit;
	
}

$webpageTitle	=	"Add Zip File For Pricing";
...
<link href="css/style.css" rel="stylesheet" type="text/css" />
	...
	<div id="page">
		...
		<div id="pageRight">
			<div id="content">
				<fieldset id="main">
					<legend>Add Zip File For Pricing</legend>
					<div class="row700">&nbsp;</div>					
					<div class="row700 redText"><?php echo $msg;?></div>
				
						<form name="frm_Continent" method="post" action="add_zipFile.php"  enctype="multipart/form-data">
						...
						<div class="row700">
					     ...
					     <div class="row700">
							<div class="row200">Zip File<span class="required">*</span></div>
							<div class="row350"><input type="file" name="txtFilename" id="txtFilename" /></div>Should be Zip File
				        </div>
