...
<img title="" src="../Images/colorpicker.gif" id="bordercolor_Preview" style="vertical-align:top;" />									
            ...
            <fieldset id="fieldsetUpload" <?php echo $Style_Display_None ; ?> >
							...
							<table border="0" cellspacing="2" cellpadding="0" width="100%" class="normal">
								...
								<tr>
									<td valign="top">
			    				    	<iframe src="upload.php?<?php echo $setting ; ?>&Theme=<?php echo $Theme; ?>&FP=<?php echo $Current_ImageGalleryPath; ?>&Type=Image" id="uploader1" frameborder="0" scrolling="auto" style="width:100%;"></iframe>
									</td>
								</tr>
							</table>
						</fieldset>
