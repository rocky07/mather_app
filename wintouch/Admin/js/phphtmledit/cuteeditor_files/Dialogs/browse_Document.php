...
error_reporting(E_ALL ^ E_NOTICE); 
    ...
    if($dirlist)
	{
        ...
        //add the html for the folders
		    $str_openfolderEvent="onclick=\"parent.SetUpload_FolderPath('".$current_Path.$folpath.$file."');location.href='browse_Document.php?".$setting."&loc=".$folpath.$file."&DP=".$current_Path."';\"";
...
<html>
  <head>
    ...
    <script type="text/javascript">
	  ...
	  var folderpath = "browse_Document.php?<?php echo $setting ; ?>&DP=<?php echo $current_Path ; ?>";
      ...
      for (i=0;i<arrloc.length-2;i++) {
			...
			str="browse_Document.php?<?php echo $setting ; ?>&DP=<?php echo $current_Path ; ?>&loc=" + str + "&u=y";
			location.href = str;
