...
<fieldset><legend><?php echo GetString("Size") ; ?></legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			...
			<td><input type="text" id="tb_top" style="width:70px" />
			...
			<td><input type="text" id="tb_height" style="width:70px" />
		...
		<tr>
			...
			<td><input type="text" id="tb_left" style="width:70px" />
			...
			<td><input type="text" id="tb_width" style="width:70px" />
...
<fieldset><legend><?php echo GetString("Clipping") ; ?></legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			<td style="width:50"><?php echo GetString("Top") ; ?></td>
			<td><input type="text" id="tb_cliptop" style="width:70px" />
			...
			<td><input type="text" id="tb_clipbottom" style="width:70px" />
		...
		<tr>
			<td style="width:50"><?php echo GetString("Left") ; ?></td>
			<td><input type="text" id="tb_clipleft" style="width:70px" />
			...
			<td><input type="text" id="tb_clipright" style="width:70px" />
