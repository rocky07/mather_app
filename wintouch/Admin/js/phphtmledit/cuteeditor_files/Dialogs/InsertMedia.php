...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>		
		...
		<style type="text/css">
	    #uploader1 {height:80; VISIBILITY: inherit; Z-INDEX: 2}
		.row { HEIGHT: 22px }
...
<input type="checkbox" name="WindowlessVideo" onchange="do_preview()" onpropertychange="do_preview()" id="WindowlessVideo" value="windowlessVideo" /></td>
            ...
            <fieldset id="fieldsetUpload" <?php echo $Style_Display_None ; ?> >
							...
							<table border="0" cellspacing="2" cellpadding="0" width="100%" class="normal">
								...
								<tr>
									<td valign="top">
<iframe src="upload.php?<?php echo $setting ; ?>&FP=<?php echo $Current_MediaGalleryPath; ?>&Theme=<?php echo $Theme; ?>&Type=media" id="uploader1" frameborder="0" scrolling="auto" style="width:100%;height:65px"></iframe>
									</td>
								</tr>
							</table>
						</fieldset>
